// https://github.com/netdur/llama_cpp_dart/blob/main/lib/src/llama_cpp.dart
// Didn't work as a package, bless MIT
//
...
class llama_cpp {
  ...
  llama_batch llama_batch_get_one( // !!! Updated
    ffi.Pointer<llama_token> tokens,
    int n_tokens,
    // int pos_0,
    // int seq_id,
  ...
  late final _llama_batch_get_onePtr = _lookup<
      ffi.NativeFunction<
          llama_batch Function(
              ffi.Pointer<llama_token>, ffi.Int32/*, llama_pos, llama_seq_id*/)>>('llama_batch_get_one');
  late final _llama_batch_get_one = _llama_batch_get_onePtr
      .asFunction<llama_batch Function(ffi.Pointer<llama_token>, int/*, int, int*/)>();
...
final class llama_batch extends ffi.Struct { // !!! Updated
  @ffi.Int32()
